...
```bash
wget https://github.com/murmurlinux/murmur/releases/download/v0.3.7/Murmur_0.3.4_amd64.AppImage
chmod +x Murmur_0.3.7_amd64.AppImage
./Murmur_0.3.7_amd64.AppImage
```
...
<!-- x-release-please-start-version -->
```bash
wget https://github.com/murmurlinux/murmur/releases/download/v0.3.7/Murmur_0.3.4_amd64.deb
sudo dpkg -i Murmur_0.3.7_amd64.deb
```
<!-- x-release-please-end -->
