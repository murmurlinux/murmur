...
```bash
wget https://github.com/murmurlinux/murmur/releases/download/v0.3.6/Murmur_0.3.4_amd64.AppImage
...
<!-- x-release-please-start-version -->
```bash
wget https://github.com/murmurlinux/murmur/releases/download/v0.3.6/Murmur_0.3.4_amd64.deb
